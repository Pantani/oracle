...
export declare type ConsumingMsgCoinRatesDataResponse = object;
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @request GET:/oracle/consuming/coin_rates_result/{requestId}
     */
    queryCoinRatesResult: (requestId: string, params?: RequestParams) => Promise<HttpResponse<ConsumingQueryCoinRatesResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryLastCoinRatesId: (params?: RequestParams) => Promise<HttpResponse<ConsumingQueryLastCoinRatesIdResponse, RpcStatus>>;
}
export {};
