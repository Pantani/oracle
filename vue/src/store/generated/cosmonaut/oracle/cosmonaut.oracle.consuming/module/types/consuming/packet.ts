...
const baseConsumingPacketData: object = {}

export const ConsumingPacketData = {
  encode(message: ConsumingPacketData, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): ConsumingPacketData {
    ...
    const message = { ...baseConsumingPacketData } as ConsumingPacketData
